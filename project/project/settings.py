...
SECRET_KEY = 'django-insecure-l8k2+)nzuzxr+g6=_s6^f(#3^it&_e)sps95=js9gd%$^22ovn'
...
DATABASES = {
    'default': {
        # 'ENGINE': 'django.db.backends.postgresql', non spasial
        'ENGINE': 'django.contrib.gis.db.backends.postgis', #spasial
        'HOST': env('DB_HOST'),
        'NAME': env('DB_NAME'),
        'USER':env('DB_USER'),
